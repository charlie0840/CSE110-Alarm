...
public class PopupAlarm extends Service//ppCompatActivity
{
  ...
  //          String ringtone = intent.getStringExtra("ringtone");
    //        in.putExtra("ringtone", ringtone);
            ...
            in.putExtra("button_color0", true);
            in.putExtra("button_color1", false);
            in.putExtra("button_color2", true);
            in.putExtra("button_color3", false);
            in.putExtra("button_color4", true);
            in.putExtra("button_color5", false);
            in.putExtra("button_color6", true);
            in.putExtra("button_color7", false);
            in.putExtra("button_color8", true);
